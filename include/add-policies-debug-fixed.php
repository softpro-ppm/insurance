...
try {
    require 'session.php';
    echo "<p style='color: green;'>✅ Session loaded successfully</p>";
} catch (Exception $e) {
...
// Simple input sanitization with error checking
try {
    ...
    echo "<p style='color: green;'>✅ Input sanitization successful</p>";
} catch (Exception $e) {
    echo "<p style='color: red;'>❌ Input sanitization error: " . $e->getMessage() . "</p>";
    exit;
}
...
echo "<li>Discount from form: $discount</li>";
echo "<li>Calculated Revenue from form: $calculated_revenue</li>";
echo "</ul>";
...
try {
    ...
    echo "<h3 style='color: red;'>❌ Database Query Error:</h3>";
