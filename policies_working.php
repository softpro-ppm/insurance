											...
											<tbody>
												<?php  
									             ...
									             echo '<tr>  
									                ...
									                <td>
									                    <a href="edit.php?id='.$r['id'].'" class="btn btn-primary btn-sm"> <i class="fas fa-pen"></i>Edit</a>
									                    <a href="include/view-policy.php?id='.$r['id'].'" class="btn btn-success btn-sm" target="_blank" ><i class="fas fa-eye"></i>View Policy</a>
									                    <a href="javascript:void(0);" onclick="deletepolicy(this)" data-id="'.$r['id'].'" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>Delete</a>
									                </td>
									                </tr>';
