                                            ...
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    <a href="policies.php?latest=latest">     
                                                        <p class="text-muted fw-medium">Policies</p>
                                                        <h4 class="mb-0"><?=$totalpolicy?></h4>
                                                    </a>    
                                                </div>
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    <a href="manage-renewal.php?renewal=renewal">
                                                        <p class="text-muted fw-medium">Total Renewal</p>
                                                        <h4 class="mb-0"><?=$renewaltotal;?></h4>
                                                    </a>
                                                </div>
                                                <div class="flex-shrink-0 align-self-center">
                                                    <div class="avatar-sm rounded-circle bg-primary mini-stat-icon"> <span class="avatar-title rounded-circle bg-primary">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    <a href="manage-renewal.php?pending=pending">
                                                        <p class="text-muted fw-medium">Pending Renewal</p>
                                                        <h4 class="mb-0"><?=$pendingrenewaltotal?></h4>
                                                    </a>
                                                </div>
                                                <div class="flex-shrink-0 align-self-center">
                                                    <div class="avatar-sm rounded-circle bg-primary mini-stat-icon"> <span class="avatar-title rounded-circle bg-primary">
