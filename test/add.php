                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select name="insurance_company" class="form-control select2" required="true" >
                                                    <option value="" >Select</option>
                                                    <option value="Tata AIG" >Tata AIG Gen</option>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <label class="form-label">Chassiss&nbsp; No.<span style="color:red;" >*</span></label>
                                                <input type="text" name="chassiss" class="form-control" required >
                                            </div>
